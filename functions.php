...
function add_custom_textarea() {
    ...
    echo '<textarea name="content" id="content" rows="5" cols="25" style="flex: 1;"></textarea>';
    echo '<textarea name="custom_textarea" id="custom_textarea" rows="5" cols="25" style="flex: 1;"></textarea>';
    echo '</div>';
}
add_action('edit_form_after_title', 'add_custom_textarea');
